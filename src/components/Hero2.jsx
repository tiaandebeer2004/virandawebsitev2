        ...
        <div className="Hero2">
            <div className="hero2Left">
                ...
                <div className="hero2ButtonGroup">
                    <a href="/virandawebsitev2/#/services"><button className="hero2OurServices">Our Services</button></a>
                    <a href="/virandawebsitev2/#/contact"><button className="hero2ContactUs">Contact Us</button></a>
                </div>
            </div>
