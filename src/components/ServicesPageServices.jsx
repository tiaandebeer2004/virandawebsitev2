    ...
    <div className="ServicesPageServices">
        <div className="servicesPageServiceMobile">
            ...
            <p className="servicesPageMobileParagraph">Losing customers to an outdated website? Our modern, mobile-friendly websites not only look beautiful – they actually get sales. Our layouts have been proven to drive conversion rates, and we offer premium SEO services to help your website rank on Google. <span className="smallerSpacing"><br></br><br></br></span>Whether you need a simple landing page or a full-blown online store, we’ll make sure your website brings the results your business deserves.</p>
                ...
                <a href='/virandawebsitev2/#/services/website-development'><button className="servicesPageServiceButton">Learn More</button></a>
        </div>
        ...
        <div className="servicesPageServiceMobile">
            ...
            <p className="servicesPageMobileParagraph">Your brand deserves to stand out. Our graphic designers create stunning graphics that help you stand out from the crowd, capture potential customers’ attention, and grow your business overall. <span className="smallerSpacing"><br></br><br></br></span>Whether you need a logo, flyers, or other marketing material, you can trust us to design the most effective visuals.</p>
                <a href='/virandawebsitev2/#/services/graphic-design'><button className="servicesPageServiceButton">Learn More</button></a>
        </div>
        ...
        <div className="servicesPageServiceMobile">
            ...
            <p className="servicesPageMobileParagraph">Posting great content, but getting no results? We create social media strategies that not only help you grow your following, but also turns your existing followers into loyal customers. <span className="smallerSpacing"><br></br><br></br></span>Which platform should you use? What kind of content should you post? Contact us and have our social media managers answer all your questions and create a strategy that works.</p>
                <a href='/virandawebsitev2/#/services/social-media-management'><button className="servicesPageServiceButton">Learn More</button></a>
        </div>
        ...
        <div className="servicesPageServiceMobile">
            ...
            <p className="servicesPageMobileParagraph">Don’t have the time to post on social media? We create scroll-stopping social media content with a focus on growing your brand and driving sales. Our excellent social media content creators stay up to date with current trends, crafting highly engaging graphics and videos that drive sales and puts your brand out there. <span className="smallerSpacing"><br></br><br></br></span>Focus on running your business – while we focus on growing it.</p>
                <a href='/virandawebsitev2/#/services/social-media-content-creation'><button className="servicesPageServiceButton">Learn More</button></a>
        </div>
        ...
        <div className="servicesPageServiceMobile">
            ...
            <p className="servicesPageMobileParagraph">Our Google Ad campaigns ensure that you’re seen by the right customers at the right time. Our optimized, targeted ad campaigns drive real results – more interested, qualified leads, more sales, and a higher return on investment.</p>
                <a href='/virandawebsitev2/#/services/google-ads-management'><button className="servicesPageServiceButton">Learn More</button></a>
        </div>
        ...
        <div className="servicesPageServiceMobile">
            ...
            <p className="servicesPageMobileParagraph">Stop boosting posts and start running campaigns that actually convert. Our Meta/Facebook ad campaigns focus on generating interested, qualified leads and driving sales. We use precise targeting and eye-catching graphic material – so that you can use Meta/Facebook Ads as a powerful tool for your business’ growth.</p>
                <a href='/virandawebsitev2/#/services/facebook-meta-ads-management'><button className="servicesPageServiceButton">Learn More</button></a>
        </div>
        ...
        <div className="servicesPageServiceMobile">
            ...
            <p className="servicesPageMobileParagraph">Know how to run targeted, optimized ad campaigns, but don’t have the material to use? Our ad creators specializes in creating aesthetically stunning, high converting ads that help you save money on ad spend, generate higher quality leads, and make more sales.</p>
                <a href='/virandawebsitev2/#/services/ad-creation'><button className="servicesPageServiceButton">Learn More</button></a>
        </div>
        ...
        <div className="servicesPageServiceMobile serviceLastMobile">
            ...
            <a href='/virandawebsitev2/#/services/search-engine-optimization'><button className="servicesPageServiceButton">Learn More</button></a>
        </div>
    ...
    <div className="servicesPageServiceWrapper">
        <div className="servicesPageServiceFromLeft">
            ...
            <div className="servicesPageServiceFromLeftColumn">
                ...
                <a href='/virandawebsitev2/#/services/graphic-design'><button className="servicesPageServiceButton serviceRight">Learn More</button></a>
            </div>
        </div>
    </div>
    ...
    <div className="servicesPageServiceWrapper">
        <div className="servicesPageServiceFromLeft">
            ...
            <div className="servicesPageServiceFromLeftColumn">
                ...
                <a href='/virandawebsitev2/#/services/social-media-content-creation'><button className="servicesPageServiceButton serviceRight">Learn More</button></a>
            </div>
          </div>
        </div>
    ...
    <div className="servicesPageServiceWrapper">
        <div className="servicesPageServiceFromLeft">
            ...
            <div className="servicesPageServiceFromLeftColumn">
                ...
                <a href='/virandawebsitev2/#/services/facebook-meta-ads-management'><button className="servicesPageServiceButton serviceRight">Learn More</button></a>
            </div>
          </div>
        </div>
